...
public:
    ...
    void createMoonIndices();
    void setupMoonBuffers();
    void setupEarthBuffers();

    void initBuffers();
    void initMatrices();
    void setUniforms(GLuint worldShaderId, GLuint moonShaderId);
    void updateCamera();
